...
declare global {
  ...
  namespace NodeJS {
    interface ProcessEnv {
      ...
      AUTH_DISABLE_PUBLIC_SIGNUP?: string;
...
export const getAuthConfig = () => {
  return createEnv({
    ...
    server: {
      ...
      AUTH_DISABLE_PUBLIC_SIGNUP: z.boolean().optional().default(false),
    ...
    runtimeEnv: {
      ...
      AUTH_DISABLE_PUBLIC_SIGNUP: process.env.AUTH_DISABLE_PUBLIC_SIGNUP === '1',

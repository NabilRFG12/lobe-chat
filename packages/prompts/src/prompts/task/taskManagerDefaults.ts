...
export const buildTaskManagerDefaultsBlock = ({
  ...
  return [
    ...
    `Default AGENT agent id: ${defaultAssigneeAgentId}`,
    'Use this id as assigneeAgentId when you decide a task should be assigned to the default AGENT assistant.',
    "Do not use it as a listTasks filter unless the user asks for AGENT's tasks.",
    '</task_manager_defaults>',
    '',
  ];
};
